...
#write to csv
data = [first_train_step, first_train_step_std, consec_train_step, consec_train_step_std, predict_time, predict_time_std]

model_name = model.__class__.__name__
filename =  model_name+f"_linearly_separable_{n_features}d_performance_indicators_JAX.csv"
header = ['first_train_step', 'first_train_step_std', 'consec_train_step', 'consec_train_step_std', 'predict_time', 'predict_time_std']
